...
plt.tight_layout()
plt.savefig('confusion_matrix_test_2Kepochs_no-audiobook-training.png', dpi=300)
plt.close()

print("Confusion matrix saved as 'confusion_matrix_test_2Kepochs_no-audiobook-training.png'")
...
plot_file = os.path.join(output_dir, "tsne_embeddings_test_set_2Kepochs_no-audiobook-training.html")
