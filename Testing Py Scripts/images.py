...
### Moving .png files from genre-categorized subdirectories to one general /images_original ###
...
class MusicGenreCNN(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(128 * 16 * 16, 256)  # Adjust the input size according to the output shape after convolutions and pooling
